    ...
    public class Keyboard implements KeyListener {
        ...
        @Override public void keyTyped(KeyEvent e) {
            ...
            switch(KeyEvent.getKeyText(e.getKeyCode())){
                case "Arriba": y -= 10; label.setIcon(getSprite().getTopAnimation());  break;
                case "Derecha": x += 10; label.setIcon(getSprite().getRightAnimation());  break;
                case "Abajo": y += 10; label.setIcon(getSprite().getBottomAnimation());  break;
                case "Izquierda": x -= 10; label.setIcon(getSprite().getLeftAnimation());  break;
        ...
        public void setGamePad(JLabel label){
            ...
            xc.addXboxControllerListener(new XboxControllerAdapter(){
                ...
                @Override public void dpad(int direction, boolean pressed){
                    ...
                    switch(direction){
                        case 0: y -= 10; label.setIcon(getSprite().getTopAnimation()); break;
                        case 1: break;
                        case 2: x += 10; label.setIcon(getSprite().getRightAnimation()); break;
                        case 3: break;
                        case 4: y += 10; label.setIcon(getSprite().getBottomAnimation());  break;
                        case 5: break;
                        case 6: x -= 10; label.setIcon(getSprite().getLeftAnimation());  break;
                        case 7: break;
                    }
                ...
                @Override public void leftThumbDirection(double direction) {
                    ...
                    if (direction > 315 && direction < 360|| direction > 0 && direction < 45) {
                        y -= 10; label.setIcon(getSprite().getTopAnimation());
                    } else if (direction > 45 && direction < 135) {
                        x += 10; label.setIcon(getSprite().getRightAnimation());
                    } else if (direction > 135 && direction < 225) {
                        y += 10; label.setIcon(getSprite().getBottomAnimation());
                    } else if (direction > 225 && direction < 315) {
                        x -= 10; label.setIcon(getSprite().getLeftAnimation());
                    }
